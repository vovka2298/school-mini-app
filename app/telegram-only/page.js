...
export default function TelegramOnlyPage() {
  ...
  useEffect(() => {
    // Получаем username бота из переменных окружения или URL
    ...
    // Периодически проверяем, не перезагрузилась ли страница в Telegram
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Debug информация:</h4>
            ...
            >
              Попробовать открыть приложение
            </button>
          </div>
        )}
      </div>
